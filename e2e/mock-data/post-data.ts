export const postOne = {
    ...
    subtitle: `European aircraft manufacturer Airbus has landed a record deal for around 400 Airbus A320 jets in one of the industry's biggest by volume`,
    ...
    content: `European aircraft manufacturer Airbus has landed a record deal for 430 Airbus A320 jets.
        The deal is one of the industry’s biggest by volume and is the most planes sold by Airbus in one batch.
        U.S. investor Bill Franke signed the agreement worth some 50 billion dollars to supply four of his airlines at the Dubai Airshow amid a flurry of deal making.
        The deals underscores how budget carriers are rewriting the rule book by combining bargain fares augmented by optional services and upgrades for which passengers pay
        additional fees.
        Airlines are also taking advantage of a recent slowdown in demand for new aircraft to negotiate competitive prices from leading manufacturers.
        The deal marks a dramatic turnaround for Airbus, which had been lagging behind archrival Boeing in the contest for orders so far this year.`
};
...
export const postTwo = {
    ...
    headline: `Zimbabwe’s military says it has seized power in a targeted assault on “criminals” around President Robert Mugabe who it is claimed were causing social and economic suffering.
        However, assurances have been given that the 93-year-old leader and his family are “safe and sound”.`,
    content: `Zimbabwean soldiers and armoured vehicles blocked roads to the main government offices, parliament and the courts in central Harare.
        On the streets, it seems to be business as usual. Eyewitnesses say Zimbabweans are going about their normal day.
        Soldiers deployed across the capital and seized the state broadcaster after Mugabe’s governing Zanu-PF party accused the head of the military of treason.
        ...
        Mnangagwa, a former security chief nicknamed “The Crocodile” was favourite to succeed his life-long political patron but was ousted a week ago to pave the way for Mugabe’s 52-year-old wife Grace to succeed him.
        ...
        According to reports, Mnangagwa had been planning to revitalise the economy by bringing back thousands of white farmers kicked off their land nearly two decades ago.
...
export const postThree = {
    ...
    subtitle: `Most countries that have access to nuclear weapons put the final decision to launch an attack in the hands of one individual`,
